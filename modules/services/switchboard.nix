  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.switchboard-prewarm = {
      ...
      serviceConfig = {
        ...
        User = "claude";
        SupplementaryGroups = [ "asterisk" ];
        EnvironmentFile = [ "-/var/lib/ntfy-sh/homepage-ntfy.env" ];   # the notifications intent is pre-warmed too
    ...
    systemd.services.switchboard-agi = {
      ...
      serviceConfig = {
        ...
        # The ntfy subscriber credential, generated by ntfy-provision (root-only
